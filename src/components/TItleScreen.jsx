...
export default function TitleScreen() {
  return (
    <main className="min-w-screen min-h-screen bg-gradient-to-b from-orange-400 to-orange-600 flex justify-center items-center overflow-y-auto fixed top-0 left-0">
